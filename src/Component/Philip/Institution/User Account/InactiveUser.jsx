...
function InactiveUser() {
  ...
  const fetchData = async () => {
    try {
      setIsLoading(true);
      const response = await axios.get("auth/register/?value=in_active", {
        headers: {
  ...
  console.log("inactive", selectedUser);
  ...
  const UserActive = async (values) => {
    ...
    try {
      ...
      const response = await axios.patch(`/auth/register/`, formData, {
        headers: {
    ...
    <div>
        ...
        <div className="small-container">
          <div className="same-as-head">
            <ul>
              ...
              <li>
                <Link to="/inactiveuser" className="actives">
      ...
      {selectedUser && (
        <div className={`modal ${activeModal ? "active" : ""}`} id="modal-1">
          ...
          <Formik
            initialValues={{
              is_supplier: selectedUser.is_supplier || false,
              is_active: selectedUser.is_active || false,
              is_client: selectedUser.is_client || false,
              is_externalemployee: selectedUser.is_externalemployee || false,
              is_workmen: selectedUser.is_workmen || false,
