...
function Services() {
        ...
        <div className="small-container">
          <div className="same-as-head">
            <ul>
              ...
              <li>
                <Link to="/services" className='activ'>Services</Link>
              </li>
              <li>
  ...
  <div className="compan">
    ...
    <p>
    With type services you can divide the work orders by type of work, for example 
    'maintenance', 'new construction' or 'renovation'. You can then filter by this in the work order list.
    </p>
