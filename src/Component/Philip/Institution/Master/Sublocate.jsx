        ...
        <div className="small-container">
          <div className="same-as-head">
            <ul>
              ...
              <li>
                <Link to="/sublocate" className='activ'>Sublocations / Objects</Link>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="Institution-main-parent">
            ...
            <div className="Institution-grid-2 bg">
              <div className="compan">
                ...
                <p>
                  You can divide work locations into sublocations or objects.
                  You can use sublocations to indicate building parts or spaces.
                  You can use objects to indicate installations or machines,
                  such as a roller shutter, central heating boiler, overhead
                  door, etc.
                </p>
