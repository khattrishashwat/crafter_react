...
function Category() {
        ...
        <div className="small-container">
          <div className="same-as-head">
            <ul>
              ...
              <li>
                <Link to="/category" className='activ'>Leave Categories</Link>
              </li>
              <li>
  ...
  <div className="compan">
    ...
    <p>
      In this menu you can add action types. When creating an action, you can
      indicate what type of action it is, for example 'call', 'send email',
      'order', 'report completed', 'confirm planning', etc. You can then filter
      by this in the action list.
    </p>
                ...
                <div className="card-body">
                  <div className="table-responsive">
                    <table className="table table-borderless mb-0">
                      ...
                      <tbody>
                        <tr className="modal-open my-bot" data-modal="modal-1">
