...
function Dates() {
        ...
        <div className="small-container">
          <div className="same-as-head">
            <ul>
              ...
              <li>
                <Link to="/dates" className='activ'>Dates</Link>
              </li>
              <li>
  ...
  <div className="compan">
    ...
    <p>
    In this menu you can add appointment types. With these appointment types you can indicate what
     type it is when creating another appointment, for example 'free', 'holiday', 'sick', 'school', etc.
    </p>
